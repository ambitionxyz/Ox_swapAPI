...
async function getQuote(account) {
  ...
  const headers = {
    "0x-api-key": "3d31945b-b09a-4402-a6f6-db0de0c19738",
...
async function listTokens() {
  ...
  console.log("list token: ", tokenListJSON);
  ...
  for (const i in tokens) {
    ...
    let html = `<img class="token_list_img" style="width: 40px;" src="${tokens[i].logoURI}"><span class="token_list_text">  ${tokens[i].symbol}</span>  
    `;
    div.innerHTML = html;
    div.onclick = () => {
...
async function getPrice() {
  ...
  console.log("---->", params);
  // const headers = {'0x-api-key: [47438a2a-2ec7-4060-9f39-d164e31e37bc]'}; // This is a placeholder. Get your live API key from the 0x Dashboard (https://dashboard.0x.org/apps)
...
},{"big-number":4,"qs":15}],3:[function(require,module,exports){
/**
...
},{"./big-number":3}],5:[function(require,module,exports){
'use strict';
...
},{"call-bind/callBound":5,"get-intrinsic":9,"object-inspect":13}]},{},[2])(2)
});
